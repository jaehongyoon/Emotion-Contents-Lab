...
{0x07, 0x07, 0x02, 0xFD}, //0x00 : �꾩썝 0
{0x07, 0x07, 0x01, 0xFE}, //0x01 : �몃��낅젰1
...
{0x07, 0x07, 0x1F, 0xE0}, //0x0C : �붾㈃�쒖떆 12
{0x07, 0x07, 0x27, 0xD8}, //0x0D : TV/�좎꽑 13
{0x07, 0x07, 0x00, 0xFF}, //0x0E : �뚯꽦�ㅼ쨷 14
{0x07, 0x07, 0x3E, 0xC1}, //0x0F : �뚮㈃�ш린 15
{0x07, 0x07, 0x23, 0xDC}, //0x10 : +100 16
{0x07, 0x07, 0x13, 0xEC}, //0x11 : �욎콈��17
{0x07, 0x07, 0x12, 0xED}, //0x12 : 梨꾨꼸 �꾨줈 18
{0x07, 0x07, 0x10, 0xEF}, //0x13 : 梨꾨꼸 �꾨옒濡�19
{0x07, 0x07, 0x07, 0xF8}, //0x14 : �뚮웾 �ш쾶 20
{0x07, 0x07, 0x0B, 0xF4}, //0x15 : �뚮웾 �묎쾶 21
{0x07, 0x07, 0x1A, 0xE5}, //0x16 : 硫붾돱 22 
{0x07, 0x07, 0x0F, 0xF0}, //0x17 : 議곗슜��23
};
int command = 0;
//-----------------------------------------------------------------
// IR ON, OFF

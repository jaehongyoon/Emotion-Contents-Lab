...
if(flag) {
TCCR0A = 0b00100011; // Just enable output on Pin 3 and disable it on Pin 11
}
else {
TCCR0A = 0b00000011; // Just enable output on Pin 3 and disable it on Pin 11
}
}
...
pinMode(3, OUTPUT);
TCCR0A = 0b00000011; // Just enable output on Pin 3 and disable it on Pin 11
TCCR0B = 0b00001010; // select a prescale value of 8:1 of the system clock
OCR0A = 52; // defines the frequency 51 = 38.4 KHz, 54 = 36.2 KHz, 58 = 34 KHz, 62 = 32 KHz
